...
<body>
    ...
    <div class="group_box bottom_blank">
        <div class="inner_box">
            <span class="label_title">${d.labelName}</span> <span
                class="clearfix label_desc">&#12288;&#12288;${d.labelDesc}</span>
            <p class="author_info" align="center">
                <strong class="logo"><img src="${d.creatorPortraitUrl}" /></strong>
                <b class="author"><i class="active">${d.creatorName}</i><em>创建者</em></b>
            </p>
        </div>
        <ul class="share_list">
            <c:forEach items="${d.simplePublishList}" var="p" varStatus="loop">
                <li>
                    <div class="li_inner">
